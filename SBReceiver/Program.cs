...
namespace SBReceiver
{
    class Program
    {
        const string connectionString = "Endpoint=sb://anservicebusdemo.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=D5hATU7XhFfJ2s9TYHQl0nJskNJgT/8M1F9rOiqRRTg=";
